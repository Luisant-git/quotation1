...
export const Socialcards: Social[] = [
    { id: 1, apps: "Purchase", data: "457K", followers: "Purchase", percent: "1.5", icon: "down", color: "danger", color1: "primary2", class: "insta" },
    { id: 2, apps: "Product", data: "457K", followers: "Followers", percent: "1.5", icon: "down", color: "danger", color1: "info", class: "linkedin" },
    { id: 3, apps: "Concern", data: "2.1K", followers: "1 hr ago", percent: "1.9", icon: "down", color: "danger", color1: "primary", class: "fb" },
    { id: 4, apps: "Sale", data: "2.1K", followers: "1 week ago", percent: "1.9", icon: "up", color: "success", color1: "dark", class: "twit" },
    { id: 5, apps: "Customer", data: "1.1M", followers: "1 day ago", percent: "1.9", icon: "up", color: "success", color1: "danger", class: "youtube" },
    { id: 6, apps: "Party", data: "1.1M", followers: "1 day ago", percent: "1.9", icon: "up", color: "success", color1: "secondary", class: "msgr" },
]
