...
import { Profilecarddata, Profilelist } from "../../../components/common/data/pages/profiledata";
import SpkProfilefriendscard from "../../../@spk-reusable-components/reusable-pages/spkprofilefriendscard";
                ...
                <Col xl={12}>
                    <Card className="custom-card profile-card">
                        <div className="profile-banner-img">
                            <img src={media3} className="card-img-top" alt="..." />
                        </div>
                                ...
                                <Col xl={3}>
                                    <Card className="custom-card overflow-hidden border">
                                        ...
                                        <div className="p-3 pb-1 d-flex flex-wrap justify-content-between">
                                            ...
                                            <Link to="#!" className="fs-12 text-muted"> View All<i className="ti ti-arrow-narrow-right ms-1 d-inline-block"></i> </Link>
                                        </div>
