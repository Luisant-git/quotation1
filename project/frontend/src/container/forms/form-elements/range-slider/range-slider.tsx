...
import LabeledTwoThumbs,{ Marks } from "../../../../components/common/data/forms/rangesliderdata";
import { rangeslider1, rangeslider2, rangeslider3, rangeslider4} from "../../../../components/common/data/prism/forms-prism";
...
const RangeSliders = ({ local_varaiable }: any) => {
