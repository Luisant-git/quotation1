...
import HorizontalNonLinearStepper from "../../../components/common/data/forms/formwizarddata";
                                                    ...
                                                    <div className="text-center p-4">
                                                        ...
                                                        <div className="mb-0">
                                                            <div className="form-check d-inline-block">
                                                                <input className="form-check-input" id="customCheck1" required type="checkbox" /> <label className="form-check-label" htmlFor="customCheck1" >I agree with the 
                                                                    <Link className="fw-medium text-decoration-underline" to={`${import.meta.env.BASE_URL}pages/terms-conditions`}>Terms and Conditions.</Link></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="row d-flex justify-content-center">
                                                <div className="col-lg-10">
                                                    <div className="text-center p-4">
                                                        ...
                                                        <div className="mb-0">
                                                            <div className="form-check d-inline-block">
                                                                <input className="form-check-input" id="customCheck2" required type="checkbox" /> <label className="form-check-label" htmlFor="customCheck2">I agree with the 
                                                                    <Link className="fw-medium text-decoration-underline" to={`${import.meta.env.BASE_URL}pages/terms-conditions`}>Terms and Conditions.</Link></label>
                                                            </div>
                                                        </div>
                                                    </div>
